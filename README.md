...
- Verify search provider is returning JSON responses
...
logger:
  logs:
    custom_components.ollama_web_search: debug
```
...
- Built on top of the official Home Assistant Ollama integration
- Inspired by OpenWebUI's web search functionality
- Thanks to the SearXNG project for privacy-respecting search
